module.exports = grammar({
  ...
  externals: $ => [
    ...
    $._htm_blk_prc_bgn,     $._htm_blk_prc_end, $._htm_blk_prc_end_mkr,
    $._htm_blk_dcl_bgn,     $._htm_blk_dcl_end, $._htm_blk_dcl_end_mkr,
    $._htm_blk_cda_bgn,     $._htm_blk_cda_end, $._htm_blk_cda_end_mkr,
    $._htm_blk_div_bgn,                         $._htm_blk_div_end_mkr,
    $._htm_blk_cmp_bgn,                         $._htm_blk_cmp_end_mkr,
    ...
    $._ext_www_aut_lnk_bgn,
    $._ext_url_aut_lnk_bgn,
    $._ext_eml_aut_lnk_bgn, $._ext_aut_lnk_end_mkr,
    $._uri_aut_lnk_bgn,
  ...
  rules: {
    ...
    _ext_www_aut_lnk_hed: $ => seq($._ext_www_aut_lnk_bgn, repeat(choice($._txt, $._bsl_esc))),
    _ext_url_aut_lnk: $ => seq($._ext_url_aut_lnk_hed, $._ext_aut_lnk_end_mkr),
    _ext_url_aut_lnk_hed: $ => seq($._ext_url_aut_lnk_bgn, repeat(choice($._txt, $._bsl_esc))),
    _ext_eml_aut_lnk: $ => seq($._ext_eml_aut_lnk_hed, $._ext_aut_lnk_end_mkr),
    _ext_eml_aut_lnk_hed: $ => seq($._ext_eml_aut_lnk_bgn, repeat(choice($._txt, $._bsl_esc))),
    ...
    _htm_opn_tag_hed: $ => seq($._htm_opn_tag_bgn, alias($._txt, $.html_tag_name), repeat($._htm_atr)),
    _htm_cls_tag: $ => seq($._htm_cls_tag_bgn, alias($._txt, $.html_tag_name), $._htm_tag_end),
    ...
    _htm_dcl: $ => seq($._htm_dcl_bgn, alias($._txt, $.html_declaration_name), repeat(choice($._txt, $._bsl_esc)), $._htm_tag_end),
    _htm_cda: $ => seq($._htm_cda_bgn, repeat(choice($._txt, $._bsl_esc)), $._htm_cda_end),
    _htm_atr: $ => seq(alias($._txt, $.html_attribute_key), optional(seq($._htm_atr_eql, $._htm_atr_val))),
    _htm_atr_val: $ => choice(
