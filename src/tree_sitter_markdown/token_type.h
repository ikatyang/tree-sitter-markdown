...
enum TokenType {
  ...
  TKN_HTM_BLK_CMT_BGN,     TKN_HTM_BLK_CMT_END, TKN_HTM_BLK_CMT_END_MKR,
  TKN_HTM_BLK_PRC_BGN,     TKN_HTM_BLK_PRC_END, TKN_HTM_BLK_PRC_END_MKR,
  TKN_HTM_BLK_DCL_BGN,     TKN_HTM_BLK_DCL_END, TKN_HTM_BLK_DCL_END_MKR,
  TKN_HTM_BLK_CDA_BGN,     TKN_HTM_BLK_CDA_END, TKN_HTM_BLK_CDA_END_MKR,
  TKN_HTM_BLK_DIV_BGN,                          TKN_HTM_BLK_DIV_END_MKR,
  TKN_HTM_BLK_CMP_BGN,                          TKN_HTM_BLK_CMP_END_MKR,
  ...
  TKN_EXT_WWW_AUT_LNK_BGN,
  TKN_EXT_URL_AUT_LNK_BGN,
  TKN_EXT_EML_AUT_LNK_BGN, TKN_EXT_AUT_LNK_END_MKR,
  TKN_URI_AUT_LNK_BGN,
